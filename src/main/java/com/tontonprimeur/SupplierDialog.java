...
public class SupplierDialog extends JDialog {
    ...
    private final JTextField nomField      = new JTextField(26);
    private final JTextField telField      = new JTextField(26);
    private final JTextField emailField    = new JTextField(26);
    private final JTextField adresseField  = new JTextField(26);

    public SupplierDialog(Frame owner, Supplier existing) {
        super(owner, true);
        setTitle(existing == null ? "Ajouter un fournisseur" : "Modifier le fournisseur");
        ...
        JLabel titleLbl = new JLabel(existing == null ? "Ajouter un fournisseur" : "Modifier le fournisseur");
        titleLbl.setFont(new Font("Segoe UI", Font.BOLD, 18));
        titleLbl.setForeground(TEXT);
        JLabel subLbl = new JLabel("Remplis les coordonnées du fournisseur.");
        ...
        styleField(adresseField);

        c.gridx = 0; c.gridy = 0; c.weightx = 0; form.add(label("Nom"),      c);
        c.gridx = 1; c.weightx = 1;                form.add(nomField,          c);
        c.gridx = 0; c.gridy = 1; c.weightx = 0; form.add(label("Téléphone"), c);
        c.gridx = 1; c.weightx = 1;                form.add(telField,          c);
        c.gridx = 0; c.gridy = 2; c.weightx = 0; form.add(label("Email"),     c);
        c.gridx = 1; c.weightx = 1;                form.add(emailField,        c);
        c.gridx = 0; c.gridy = 3; c.weightx = 0; form.add(label("Adresse"),   c);
        c.gridx = 1; c.weightx = 1;                form.add(adresseField,      c);
    ...
    private JLabel label(String text) {
        ...
        l.setPreferredSize(new Dimension(82, 42));
        return l;
    }
    ...
    private void onSave(Supplier existing) {
        ...
        result = new Supplier(id, nom, telField.getText().trim(), emailField.getText().trim(), adresseField.getText().trim());
        dispose();
    }

    public Supplier getResult() { return result; }
